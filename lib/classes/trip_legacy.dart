...
import 'package:travel_planner/classes/accomodation_legacy.dart';
...
class TripLegacy {
  ...
  TripLegacy(this.name, this.docID, this.tripStartTime, this.stops,
      this.transportation, this.accomodation);

  factory TripLegacy.fromFirestore(QueryDocumentSnapshot<Object?> data) {
